...
var Ipfs = /** @class */ (function (_super) {
    ...
    Ipfs.prototype.exec = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var start, stop, config, isRunning;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        start = this.arg("start");
                        stop = this.arg("stop");
                        config = (_b = (_a = this.session) === null || _a === void 0 ? void 0 : _a.manifest) === null || _b === void 0 ? void 0 : _b.load();
                        isRunning = config.ipfsRunning;
                        if (!(start && !isRunning)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.start()];
                    case 1:
                        _g.sent();
                        (_d = (_c = this.session) === null || _c === void 0 ? void 0 : _c.manifest) === null || _d === void 0 ? void 0 : _d.update({
                            ipfsRunning: true
                        });
                        return [2 /*return*/];
                    case 2:
