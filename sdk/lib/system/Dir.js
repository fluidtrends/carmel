...
var Dir = /** @class */ (function () {
    ...
    Dir.prototype.copy = function (dir) {
        if (dir.exists)
            return dir;
        fs_extra_1.default.existsSync(path_1.default.dirname(dir.path)) ||
            fs_extra_1.default.mkdirsSync(path_1.default.dirname(dir.path));
    ...
    Object.defineProperty(Dir.prototype, "dirs", {
        get: function () {
            ...
            return fs_extra_1.default
                ...
                .filter(function (d) { return fs_extra_1.default.lstatSync(path_1.default.resolve(_this.path, d)).isDirectory(); });
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Dir.prototype, "files", {
        get: function () {
            var _this = this;
            if (!this.exists) {
                return [];
            ...
            return fs_extra_1.default
                .readdirSync(this.path)
                .filter(function (f) { return fs_extra_1.default.lstatSync(path_1.default.resolve(_this.path, f)).isFile(); });
        },
        enumerable: false,
        configurable: true
    });
