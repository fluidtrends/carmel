...
var Engine = /** @class */ (function () {
    /** @internal */
    function Engine() {
        this._state = _1.EngineState.STOPPED;
    }
    ...
    Object.defineProperty(Engine.prototype, "isStarted", {
         ...
         */
        get: function () {
            return this._state >= _1.EngineState.STARTED && this.hasSession;
        },
        enumerable: false,
        configurable: true
    });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this._session = new _1.Session(props);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.changeState(_1.EngineState.STARTING);
                        // This engine is not started yet, let's begin by assigning a new Session
                    ...
                    case 1:
                        ...
                        _a.sent();
                        // We're now started and ready to go
                        this.changeState(_1.EngineState.READY);
    ...
    Engine.prototype.stop = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                ...
                this.changeState(_1.EngineState.STOPPED);
     ...
     */
    Engine.prototype.exec = function (command) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this._session) {
                            ...
                            throw _1.Errors.SessionIsMissing();
                        }
                        if (!command) {
                            // Likewise, don't do anything without a command
                            throw _1.Errors.CommandIsMissing();
                        }
                        if (!this.isStarted) {
                        ...
                        Engine.instance.changeState(_1.EngineState.RUNNING);
                        // Time to let the command do its thing
                        return [4 /*yield*/, (command === null || command === void 0 ? void 0 : command.exec(this._session))];
                    case 1:
                        // Time to let the command do its thing
                        _a.sent();
                        // We're done running
                        Engine.instance.changeState(_1.EngineState.READY);
                        return [2 /*return*/];
                }
            });
        });
     ...
     */
    Engine.run = function (command, onlyOnce) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.sent();
                        // Let's let this command run
                        return [4 /*yield*/, Engine.instance.exec(command)
