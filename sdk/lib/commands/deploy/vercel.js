...
exports.deploy = function (token, path) { return __awaiter(void 0, void 0, void 0, function () {
    var deployment, _a, _b, event_1, e_1_1;
    var e_1, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _d.trys.push([0, 5, 6, 11]);
                _a = __asyncValues(client_1.createDeployment({
                    token: token,
                    path: path,
                }));
                _d.label = 1;
            ...
            case 11: return [2 /*return*/, deployment];
        }
    });
}); };
